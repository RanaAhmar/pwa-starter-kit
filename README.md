[![Stars](https://img.shields.io/github/stars/RanaAhmar/pwa-starter-kit?style=for-the-badge)](https://github.com/RanaAhmar/pwa-starter-kit/stargazers) [![Issues](https://img.shields.io/github/issues/RanaAhmar/pwa-starter-kit?style=for-the-badge)](https://github.com/RanaAhmar/pwa-starter-kit/issues) [![MIT License](https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge)](https://github.com/RanaAhmar/pwa-starter-kit/blob/main/LICENSE)

# 📱 PWA Starter Kit

Everything you need to build a high-performance Progressive Web App. Manifests, Service Workers, and Push Notifications ready out of the box. By **Ahmar Hussain** (**Stackaura**).
